...
cursor.execute("""SELECT note_count FROM Text where timestamp>1333312781""")
l1 = cursor.fetchall()
cursor.execute("""SELECT note_count FROM Photo where timestamp>1333312781""")
l2 = cursor.fetchall()
cursor.execute("""SELECT note_count FROM Quote where timestamp>1333312781""")
l3 = cursor.fetchall()
cursor.execute("""SELECT note_count FROM Chat where timestamp>1333312781""")
l4 = cursor.fetchall()
...
plt3.savefig('9s7median_got.png')
plt3.show()
...
plt3.title('SEASON 1')
plt3.legend(loc='upper left')
plt3.savefig('9s1median_got.png')
plt3.show()
