...
l1 = []
cursor.execute("""SELECT id,body FROM Text where timestamp>1450940602""")
l1 = cursor.fetchall()
...
print('Positive tags in S4 : ')
for i in range(0,10):
	print(dic_pos_tag[i],dic_pos_value[i])

print()
print('Negative tags in S4 : ')
print()
for i in range(0,10):
...
print()
print('Positive tags in S3 : ')
print()
for i in range(0,10):
	print(dic_pos_tag[i],dic_pos_value[i])

print()
print('Negative tags in S3 : ')
print()
for i in range(0,10):
	print(dic_neg_tag[i],dic_neg_value[i])
