...
cursor.execute("""SELECT note_count FROM Text where timestamp>1450940602""")
l1 = cursor.fetchall()
cursor.execute("""SELECT note_count FROM Photo where timestamp>1450940602""")
l2 = cursor.fetchall()
cursor.execute("""SELECT note_count FROM Quote where timestamp>1450940602""")
l3 = cursor.fetchall()
cursor.execute("""SELECT note_count FROM Chat where timestamp>1450940602""")
l4 = cursor.fetchall()
...
plt3.savefig('9s7median_sher.png')
plt3.show()
...
plt3.title('SEASON 3')
plt3.legend(loc='upper left')
plt3.savefig('9s1median_sher.png')
plt3.show()
