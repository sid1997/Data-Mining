...
cursor.execute("""SELECT note_count FROM Text where timestamp>1411385659""")
l1 = cursor.fetchall()
cursor.execute("""SELECT note_count FROM Photo where timestamp>1411385659""")
l2 = cursor.fetchall()
cursor.execute("""SELECT note_count FROM Quote where timestamp>1411385659""")
l3 = cursor.fetchall()
cursor.execute("""SELECT note_count FROM Chat where timestamp>1411385659""")
l4 = cursor.fetchall()
...
plt3.title('SEASON 6')
plt3.legend(loc='upper left')
plt3.savefig('9s6median_BBT.png')
plt3.show()
