...
l1 = []
cursor.execute("""SELECT id,body FROM Text where timestamp>1411385659""")
l1 = cursor.fetchall()
...
print('Positive tags in S10 : ')
for i in range(0,10):
	print(dic_pos_tag[i],dic_pos_value[i])

print()
print('Negative tags in S10 : ')
print()
for i in range(0,10):
...
print()
print('Positive tags in S6 : ')
print()
for i in range(0,10):
	print(dic_pos_tag[i],dic_pos_value[i])

print()
print('Negative tags in S6 : ')
print()
for i in range(0,10):
	print(dic_neg_tag[i],dic_neg_value[i])
